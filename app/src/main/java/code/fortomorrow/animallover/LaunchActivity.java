...
public class LaunchActivity extends AppCompatActivity {
    ...
    private int about_images_array[] = {
            R.drawable.catback,
            R.drawable.animal_lover_background,
            R.drawable.splash_screen,
            R.drawable.deginupper
    };
...
//        Tools.setSystemBarLight(this);
    ...
    private void bottomProgressDots(int current_index) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setImageResource(R.drawable.ic_baseline_vpn_key_24);
            dots[i].setColorFilter(getResources().getColor(R.color.grey_20), PorterDuff.Mode.SRC_IN);
            dotsLayout.addView(dots[i]);
        }

        if (dots.length > 0) {
            dots[current_index].setImageResource(R.drawable.ic_baseline_email_24);
